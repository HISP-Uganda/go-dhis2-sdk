...
func NewTrackerTypeReport(trackerType string) *TrackerTypeReport {
...
func (o *TrackerTypeReport) GetTrackerType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TrackerTypeReport) GetTrackerTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TrackerTypeReport) SetTrackerType(v string) {
	o.TrackerType = v
}
