...
// []map[string]interface{}AsRelationshipTypeGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in RelationshipTypeGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsRelationshipTypeGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) RelationshipTypeGetObjectListGistGetObjectListGistAsCsv200Response {
	return RelationshipTypeGetObjectListGistGetObjectListGistAsCsv200Response{
