...
func NewProcessInfo(status string) *ProcessInfo {
	this := ProcessInfo{}
	this.Status = status
	return &this
}
...
func (o *ProcessInfo) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProcessInfo) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProcessInfo) SetStatus(v string) {
	o.Status = v
}
