...
func (o *AttributeValueFilter) GetNull() bool {
...
// and a boolean to check if the value has been set.
func (o *AttributeValueFilter) GetNullOk() (*bool, bool) {
	if o == nil || IsNil(o.Null) {
		return nil, false
	}
	return o.Null, true
...
func (o *AttributeValueFilter) HasNull() bool {
	if o != nil && !IsNil(o.Null) {
		return true
	}
...
func (o *AttributeValueFilter) SetNull(v bool) {
	o.Null = &v
}
