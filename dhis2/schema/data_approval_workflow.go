...
type DataApprovalWorkflow struct {
	...
	DataApprovalLevels []BaseIdentifiableObject `json:"dataApprovalLevels,omitempty"`
...
func (o *DataApprovalWorkflow) GetCategoryCombo() BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *DataApprovalWorkflow) GetCategoryComboOk() (*BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.CategoryCombo) {
		return nil, false
	}
...
func (o *DataApprovalWorkflow) SetCategoryCombo(v BaseIdentifiableObject) {
	o.CategoryCombo = &v
}
...
func (o *DataApprovalWorkflow) GetCreatedBy() UserDto {
...
// and a boolean to check if the value has been set.
func (o *DataApprovalWorkflow) GetCreatedByOk() (*UserDto, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *DataApprovalWorkflow) SetCreatedBy(v UserDto) {
	o.CreatedBy = &v
}

// GetDataApprovalLevels returns the DataApprovalLevels field value if set, zero value otherwise.
func (o *DataApprovalWorkflow) GetDataApprovalLevels() []BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *DataApprovalWorkflow) GetDataApprovalLevelsOk() ([]BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.DataApprovalLevels) {
		return nil, false
	}
...
// SetDataApprovalLevels gets a reference to the given []BaseIdentifiableObject and assigns it to the DataApprovalLevels field.
func (o *DataApprovalWorkflow) SetDataApprovalLevels(v []BaseIdentifiableObject) {
	o.DataApprovalLevels = v
}

// GetDataSets returns the DataSets field value if set, zero value otherwise.
func (o *DataApprovalWorkflow) GetDataSets() []BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *DataApprovalWorkflow) GetDataSetsOk() ([]BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.DataSets) {
		return nil, false
	}
...
func (o *DataApprovalWorkflow) SetDataSets(v []BaseIdentifiableObject) {
	o.DataSets = v
}
...
func (o *DataApprovalWorkflow) GetLastUpdatedBy() UserDto {
...
// and a boolean to check if the value has been set.
func (o *DataApprovalWorkflow) GetLastUpdatedByOk() (*UserDto, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *DataApprovalWorkflow) SetLastUpdatedBy(v UserDto) {
	o.LastUpdatedBy = &v
}
