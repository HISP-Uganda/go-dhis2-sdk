...
// []map[string]interface{}AsSectionGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in SectionGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsSectionGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) SectionGetObjectListGistGetObjectListGistAsCsv200Response {
	return SectionGetObjectListGistGetObjectListGistAsCsv200Response{
