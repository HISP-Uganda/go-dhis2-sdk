...
func (o *Form) GetOptions() map[string]any {
...
// and a boolean to check if the value has been set.
func (o *Form) GetOptionsOk() (*map[string]any, bool) {
	if o == nil || IsNil(o.Options) {
		return nil, false
	}
...
// SetOptions gets a reference to the given map[string]any and assigns it to the Options field.
func (o *Form) SetOptions(v map[string]any) {
	o.Options = &v
}
