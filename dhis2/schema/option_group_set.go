...
type OptionGroupSet struct {
	...
	OptionGroups          []OptionGroupSetOptionGroupsInner `json:"optionGroups,omitempty"`
...
func NewOptionGroupSet(aggregationType string, dataDimensionType string, valueType string) *OptionGroupSet {
	this := OptionGroupSet{}
...
func (o *OptionGroupSet) GetAggregationType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetAggregationTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OptionGroupSet) SetAggregationType(v string) {
	o.AggregationType = v
}
...
func (o *OptionGroupSet) GetCreatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetCreatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *OptionGroupSet) SetCreatedBy(v AggregateDataExchangeCreatedBy) {
	o.CreatedBy = &v
}
...
func (o *OptionGroupSet) GetDataDimensionType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetDataDimensionTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OptionGroupSet) SetDataDimensionType(v string) {
...
func (o *OptionGroupSet) GetExternalAccess() bool {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetExternalAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.ExternalAccess) {
		return nil, false
	}
...
func (o *OptionGroupSet) HasExternalAccess() bool {
	if o != nil && !IsNil(o.ExternalAccess) {
		return true
	}
...
func (o *OptionGroupSet) SetExternalAccess(v bool) {
	o.ExternalAccess = &v
}
...
func (o *OptionGroupSet) GetItems() []CategoryItemsInner {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetItemsOk() ([]CategoryItemsInner, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
func (o *OptionGroupSet) SetItems(v []CategoryItemsInner) {
	o.Items = v
}
...
func (o *OptionGroupSet) GetLastUpdatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetLastUpdatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *OptionGroupSet) SetLastUpdatedBy(v AggregateDataExchangeCreatedBy) {
	o.LastUpdatedBy = &v
}

// GetLegendSet returns the LegendSet field value if set, zero value otherwise.
func (o *OptionGroupSet) GetLegendSet() CategoryLegendSet {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetLegendSetOk() (*CategoryLegendSet, bool) {
	if o == nil || IsNil(o.LegendSet) {
		return nil, false
	}
...
func (o *OptionGroupSet) SetLegendSet(v CategoryLegendSet) {
	o.LegendSet = &v
}
...
func (o *OptionGroupSet) GetOptionGroups() []OptionGroupSetOptionGroupsInner {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetOptionGroupsOk() ([]OptionGroupSetOptionGroupsInner, bool) {
	if o == nil || IsNil(o.OptionGroups) {
		return nil, false
	}
...
// SetOptionGroups gets a reference to the given []OptionGroupSetOptionGroupsInner and assigns it to the OptionGroups field.
func (o *OptionGroupSet) SetOptionGroups(v []OptionGroupSetOptionGroupsInner) {
	o.OptionGroups = v
}

// GetOptionSet returns the OptionSet field value if set, zero value otherwise.
func (o *OptionGroupSet) GetOptionSet() AttributeOptionSet {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetOptionSetOk() (*AttributeOptionSet, bool) {
	if o == nil || IsNil(o.OptionSet) {
		return nil, false
	}
...
func (o *OptionGroupSet) SetOptionSet(v AttributeOptionSet) {
	o.OptionSet = &v
}

// GetProgramStage returns the ProgramStage field value if set, zero value otherwise.
func (o *OptionGroupSet) GetProgramStage() CategoryProgramStage {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetProgramStageOk() (*CategoryProgramStage, bool) {
	if o == nil || IsNil(o.ProgramStage) {
		return nil, false
	}
...
func (o *OptionGroupSet) SetProgramStage(v CategoryProgramStage) {
	o.ProgramStage = &v
}

// GetPublicAccess returns the PublicAccess field value if set, zero value otherwise.
func (o *OptionGroupSet) GetPublicAccess() string {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetPublicAccessOk() (*string, bool) {
	if o == nil || IsNil(o.PublicAccess) {
		return nil, false
	}
...
func (o *OptionGroupSet) HasPublicAccess() bool {
	if o != nil && !IsNil(o.PublicAccess) {
		return true
	}
...
func (o *OptionGroupSet) SetPublicAccess(v string) {
	o.PublicAccess = &v
}
...
func (o *OptionGroupSet) GetUser() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetUserOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *OptionGroupSet) HasUser() bool {
	if o != nil && !IsNil(o.User) {
		return true
	}
...
func (o *OptionGroupSet) SetUser(v AggregateDataExchangeCreatedBy) {
	o.User = &v
}

// GetUserAccesses returns the UserAccesses field value if set, zero value otherwise.
func (o *OptionGroupSet) GetUserAccesses() []LegacyUserAccess {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetUserAccessesOk() ([]LegacyUserAccess, bool) {
	if o == nil || IsNil(o.UserAccesses) {
		return nil, false
	}
...
func (o *OptionGroupSet) HasUserAccesses() bool {
	if o != nil && !IsNil(o.UserAccesses) {
		return true
	}
...
func (o *OptionGroupSet) SetUserAccesses(v []LegacyUserAccess) {
	o.UserAccesses = v
}

// GetUserGroupAccesses returns the UserGroupAccesses field value if set, zero value otherwise.
func (o *OptionGroupSet) GetUserGroupAccesses() []LegacyUserGroupAccess {
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetUserGroupAccessesOk() ([]LegacyUserGroupAccess, bool) {
	if o == nil || IsNil(o.UserGroupAccesses) {
		return nil, false
	}
...
func (o *OptionGroupSet) HasUserGroupAccesses() bool {
	if o != nil && !IsNil(o.UserGroupAccesses) {
		return true
	}
...
func (o *OptionGroupSet) SetUserGroupAccesses(v []LegacyUserGroupAccess) {
	o.UserGroupAccesses = v
}

// GetValueType returns the ValueType field value
func (o *OptionGroupSet) GetValueType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OptionGroupSet) GetValueTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OptionGroupSet) SetValueType(v string) {
	o.ValueType = v
}
