...
type DataElementGroupSetDimension struct {
	DataElementGroupSet *DataElementGroupGroupSetsInner            `json:"dataElementGroupSet,omitempty"`
...
func (o *DataElementGroupSetDimension) GetDataElementGroupSet() DataElementGroupGroupSetsInner {
...
func (o *DataElementGroupSetDimension) GetDataElementGroupSetOk() (*DataElementGroupGroupSetsInner, bool) {
	if o == nil || IsNil(o.DataElementGroupSet) {
		return nil, false
	}
...
// SetDataElementGroupSet gets a reference to the given DataElementGroupGroupSetsInner and assigns it to the DataElementGroupSet field.
func (o *DataElementGroupSetDimension) SetDataElementGroupSet(v DataElementGroupGroupSetsInner) {
	o.DataElementGroupSet = &v
}

// GetDataElementGroups returns the DataElementGroups field value if set, zero value otherwise.
func (o *DataElementGroupSetDimension) GetDataElementGroups() []ConfigurationInfrastructuralDataElements {
...
// and a boolean to check if the value has been set.
func (o *DataElementGroupSetDimension) GetDataElementGroupsOk() ([]ConfigurationInfrastructuralDataElements, bool) {
	if o == nil || IsNil(o.DataElementGroups) {
		return nil, false
	}
...
func (o *DataElementGroupSetDimension) SetDataElementGroups(v []ConfigurationInfrastructuralDataElements) {
