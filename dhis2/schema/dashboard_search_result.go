...
type DashboardSearchResult struct {
	...
	EventCharts             []DashboardItemEventVisualization               `json:"eventCharts,omitempty"`
	EventReportCount        int32                                           `json:"eventReportCount"`
	EventReports            []DashboardItemEventVisualization               `json:"eventReports,omitempty"`
	EventVisualizationCount int32                                           `json:"eventVisualizationCount"`
	EventVisualizations     []DashboardSearchResultEventVisualizationsInner `json:"eventVisualizations,omitempty"`
	MapCount                int32                                           `json:"mapCount"`
	Maps                    []DashboardItemMap                              `json:"maps,omitempty"`
	...
	Visualizations          []DashboardSearchResultVisualizationsInner      `json:"visualizations,omitempty"`
}
...
func (o *DashboardSearchResult) GetEventCharts() []DashboardItemEventVisualization {
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetEventChartsOk() ([]DashboardItemEventVisualization, bool) {
	if o == nil || IsNil(o.EventCharts) {
		return nil, false
	}
...
// SetEventCharts gets a reference to the given []DashboardItemEventVisualization and assigns it to the EventCharts field.
func (o *DashboardSearchResult) SetEventCharts(v []DashboardItemEventVisualization) {
	o.EventCharts = v
}
...
func (o *DashboardSearchResult) GetEventReports() []DashboardItemEventVisualization {
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetEventReportsOk() ([]DashboardItemEventVisualization, bool) {
	if o == nil || IsNil(o.EventReports) {
		return nil, false
	}
...
// SetEventReports gets a reference to the given []DashboardItemEventVisualization and assigns it to the EventReports field.
func (o *DashboardSearchResult) SetEventReports(v []DashboardItemEventVisualization) {
	o.EventReports = v
}
...
func (o *DashboardSearchResult) GetEventVisualizations() []DashboardSearchResultEventVisualizationsInner {
	if o == nil || IsNil(o.EventVisualizations) {
		var ret []DashboardSearchResultEventVisualizationsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetEventVisualizationsOk() ([]DashboardSearchResultEventVisualizationsInner, bool) {
	if o == nil || IsNil(o.EventVisualizations) {
		return nil, false
	}
...
// SetEventVisualizations gets a reference to the given []DashboardSearchResultEventVisualizationsInner and assigns it to the EventVisualizations field.
func (o *DashboardSearchResult) SetEventVisualizations(v []DashboardSearchResultEventVisualizationsInner) {
...
func (o *DashboardSearchResult) GetMaps() []DashboardItemMap {
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetMapsOk() ([]DashboardItemMap, bool) {
	if o == nil || IsNil(o.Maps) {
		return nil, false
	}
	return o.Maps, true
...
// SetMaps gets a reference to the given []DashboardItemMap and assigns it to the Maps field.
func (o *DashboardSearchResult) SetMaps(v []DashboardItemMap) {
	o.Maps = v
}
...
func (o *DashboardSearchResult) GetReports() []DashboardItemReportsInner {
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetReportsOk() ([]DashboardItemReportsInner, bool) {
	if o == nil || IsNil(o.Reports) {
		return nil, false
	}
...
func (o *DashboardSearchResult) SetReports(v []DashboardItemReportsInner) {
	o.Reports = v
}
...
func (o *DashboardSearchResult) GetResources() []DashboardItemResourcesInner {
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetResourcesOk() ([]DashboardItemResourcesInner, bool) {
	if o == nil || IsNil(o.Resources) {
		return nil, false
	}
...
func (o *DashboardSearchResult) SetResources(v []DashboardItemResourcesInner) {
	o.Resources = v
}
...
func (o *DashboardSearchResult) GetUsers() []AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetUsersOk() ([]AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.Users) {
		return nil, false
	}
	return o.Users, true
...
func (o *DashboardSearchResult) SetUsers(v []AggregateDataExchangeCreatedBy) {
	o.Users = v
}
...
func (o *DashboardSearchResult) GetVisualizations() []DashboardSearchResultVisualizationsInner {
	if o == nil || IsNil(o.Visualizations) {
		var ret []DashboardSearchResultVisualizationsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DashboardSearchResult) GetVisualizationsOk() ([]DashboardSearchResultVisualizationsInner, bool) {
	if o == nil || IsNil(o.Visualizations) {
		return nil, false
	}
...
// SetVisualizations gets a reference to the given []DashboardSearchResultVisualizationsInner and assigns it to the Visualizations field.
func (o *DashboardSearchResult) SetVisualizations(v []DashboardSearchResultVisualizationsInner) {
	o.Visualizations = v
}
