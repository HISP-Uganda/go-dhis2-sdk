...
func NewDataIntegrityCheck(sectionOrder int32, severity DataIntegritySeverity) *DataIntegrityCheck {
...
func (o *DataIntegrityCheck) GetSeverity() DataIntegritySeverity {
	if o == nil {
		var ret DataIntegritySeverity
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DataIntegrityCheck) GetSeverityOk() (*DataIntegritySeverity, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataIntegrityCheck) SetSeverity(v DataIntegritySeverity) {
	o.Severity = v
}
