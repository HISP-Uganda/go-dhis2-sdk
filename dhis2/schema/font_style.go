...
func NewFontStyle(font Font, textAlign TextAlign) *FontStyle {
	this := FontStyle{}
	this.Font = font
...
// and a boolean to check if the value has been set.
func (o *FontStyle) GetFontOk() (*Font, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Font, true
...
func (o *FontStyle) SetFont(v Font) {
	o.Font = v
}
...
func (o *FontStyle) GetTextAlign() TextAlign {
	if o == nil {
		var ret TextAlign
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FontStyle) GetTextAlignOk() (*TextAlign, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FontStyle) SetTextAlign(v TextAlign) {
	o.TextAlign = v
}
