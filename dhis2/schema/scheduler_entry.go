...
func NewSchedulerEntry(status string) *SchedulerEntry {
	this := SchedulerEntry{}
	this.Status = status
	return &this
}
...
func (o *SchedulerEntry) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SchedulerEntry) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SchedulerEntry) SetStatus(v string) {
	o.Status = v
}
