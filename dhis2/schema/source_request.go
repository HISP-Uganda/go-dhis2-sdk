...
func NewSourceRequest(aggregationType string) *SourceRequest {
	this := SourceRequest{}
...
func (o *SourceRequest) GetAggregationType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *SourceRequest) GetAggregationTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SourceRequest) SetAggregationType(v string) {
	o.AggregationType = v
}
