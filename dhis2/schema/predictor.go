...
type Predictor struct {
	...
	OrganisationUnitLevels      []BaseIdentifiableObject    `json:"organisationUnitLevels,omitempty"`
	Output                      *DataElement                `json:"output,omitempty"`
	OutputCombo                 *CategoryOptionCombo        `json:"outputCombo,omitempty"`
	PeriodType                  *string                     `json:"periodType,omitempty"`
	PredictorGroups             []BaseIdentifiableObject    `json:"predictorGroups,omitempty"`
...
func NewPredictor(organisationUnitDescendants OrganisationUnitDescendants) *Predictor {
	this := Predictor{}
...
func (o *Predictor) GetCreatedBy() UserDto {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetCreatedByOk() (*UserDto, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *Predictor) SetCreatedBy(v UserDto) {
	o.CreatedBy = &v
}
...
func (o *Predictor) GetLastUpdatedBy() UserDto {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetLastUpdatedByOk() (*UserDto, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *Predictor) SetLastUpdatedBy(v UserDto) {
	o.LastUpdatedBy = &v
}
...
func (o *Predictor) GetOrganisationUnitDescendants() OrganisationUnitDescendants {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetOrganisationUnitDescendantsOk() (*OrganisationUnitDescendants, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Predictor) SetOrganisationUnitDescendants(v OrganisationUnitDescendants) {
...
func (o *Predictor) GetOrganisationUnitLevels() []BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetOrganisationUnitLevelsOk() ([]BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.OrganisationUnitLevels) {
		return nil, false
	}
...
// SetOrganisationUnitLevels gets a reference to the given []BaseIdentifiableObject and assigns it to the OrganisationUnitLevels field.
func (o *Predictor) SetOrganisationUnitLevels(v []BaseIdentifiableObject) {
	o.OrganisationUnitLevels = v
}

// GetOutput returns the Output field value if set, zero value otherwise.
func (o *Predictor) GetOutput() DataElement {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetOutputOk() (*DataElement, bool) {
	if o == nil || IsNil(o.Output) {
		return nil, false
	}
...
// SetOutput gets a reference to the given DataElement and assigns it to the Output field.
func (o *Predictor) SetOutput(v DataElement) {
	o.Output = &v
}

// GetOutputCombo returns the OutputCombo field value if set, zero value otherwise.
func (o *Predictor) GetOutputCombo() CategoryOptionCombo {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetOutputComboOk() (*CategoryOptionCombo, bool) {
	if o == nil || IsNil(o.OutputCombo) {
		return nil, false
	}
...
// SetOutputCombo gets a reference to the given CategoryOptionCombo and assigns it to the OutputCombo field.
func (o *Predictor) SetOutputCombo(v CategoryOptionCombo) {
	o.OutputCombo = &v
}
...
func (o *Predictor) GetPredictorGroups() []BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *Predictor) GetPredictorGroupsOk() ([]BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.PredictorGroups) {
		return nil, false
	}
...
// SetPredictorGroups gets a reference to the given []BaseIdentifiableObject and assigns it to the PredictorGroups field.
func (o *Predictor) SetPredictorGroups(v []BaseIdentifiableObject) {
	o.PredictorGroups = v
}
