...
func (o *ImportConflicts) GetConflicts() bool {
...
// and a boolean to check if the value has been set.
func (o *ImportConflicts) GetConflictsOk() (*bool, bool) {
	if o == nil || IsNil(o.Conflicts) {
		return nil, false
	}
...
// SetConflicts gets a reference to the given bool and assigns it to the Conflicts field.
func (o *ImportConflicts) SetConflicts(v bool) {
	o.Conflicts = &v
}
