...
// []map[string]interface{}AsIndicatorGroupGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in IndicatorGroupGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsIndicatorGroupGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) IndicatorGroupGetObjectListGistGetObjectListGistAsCsv200Response {
	return IndicatorGroupGetObjectListGistGetObjectListGistAsCsv200Response{
