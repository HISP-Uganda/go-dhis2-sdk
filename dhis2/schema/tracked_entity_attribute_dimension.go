...
type TrackedEntityAttributeDimension struct {
	Attribute *BaseIdentifiableObject `json:"attribute,omitempty"`
...
func (o *TrackedEntityAttributeDimension) GetAttribute() BaseIdentifiableObject {
...
func (o *TrackedEntityAttributeDimension) GetAttributeOk() (*BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.Attribute) {
		return nil, false
	}
...
// SetAttribute gets a reference to the given BaseIdentifiableObject and assigns it to the Attribute field.
func (o *TrackedEntityAttributeDimension) SetAttribute(v BaseIdentifiableObject) {
	o.Attribute = &v
}
...
func (o *TrackedEntityAttributeDimension) GetLegendSet() BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *TrackedEntityAttributeDimension) GetLegendSetOk() (*BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.LegendSet) {
		return nil, false
	}
...
func (o *TrackedEntityAttributeDimension) SetLegendSet(v BaseIdentifiableObject) {
	o.LegendSet = &v
}
