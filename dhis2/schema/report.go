...
func NewReport(cacheStrategy string, type_ string) *Report {
	this := Report{}
...
func (o *Report) GetAccess() Access {
...
func (o *Report) GetAccessOk() (*Access, bool) {
	if o == nil || IsNil(o.Access) {
		return nil, false
	}
...
func (o *Report) SetAccess(v Access) {
	o.Access = &v
}

// GetAttributeValues returns the AttributeValues field value if set, zero value otherwise.
func (o *Report) GetAttributeValues() []AttributeValue {
...
// and a boolean to check if the value has been set.
func (o *Report) GetAttributeValuesOk() ([]AttributeValue, bool) {
	if o == nil || IsNil(o.AttributeValues) {
		return nil, false
	}
...
func (o *Report) HasAttributeValues() bool {
	if o != nil && !IsNil(o.AttributeValues) {
		return true
	}
...
func (o *Report) SetAttributeValues(v []AttributeValue) {
	o.AttributeValues = v
}

// GetCacheStrategy returns the CacheStrategy field value
func (o *Report) GetCacheStrategy() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Report) GetCacheStrategyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Report) SetCacheStrategy(v string) {
	o.CacheStrategy = v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *Report) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *Report) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Report) SetCode(v string) {
	o.Code = &v
}

// GetCreated returns the Created field value if set, zero value otherwise.
func (o *Report) GetCreated() time.Time {
...
// and a boolean to check if the value has been set.
func (o *Report) GetCreatedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Created) {
		return nil, false
	}
...
func (o *Report) SetCreated(v time.Time) {
	o.Created = &v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *Report) GetCreatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Report) GetCreatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *Report) SetCreatedBy(v AggregateDataExchangeCreatedBy) {
	o.CreatedBy = &v
}

// GetDesignContent returns the DesignContent field value if set, zero value otherwise.
func (o *Report) GetDesignContent() string {
...
// and a boolean to check if the value has been set.
func (o *Report) GetDesignContentOk() (*string, bool) {
	if o == nil || IsNil(o.DesignContent) {
		return nil, false
	}
...
func (o *Report) HasDesignContent() bool {
	if o != nil && !IsNil(o.DesignContent) {
		return true
	}
...
func (o *Report) SetDesignContent(v string) {
	o.DesignContent = &v
}
...
func (o *Report) GetExternalAccess() bool {
...
// and a boolean to check if the value has been set.
func (o *Report) GetExternalAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.ExternalAccess) {
		return nil, false
	}
...
func (o *Report) HasExternalAccess() bool {
	if o != nil && !IsNil(o.ExternalAccess) {
		return true
	}
...
func (o *Report) SetExternalAccess(v bool) {
	o.ExternalAccess = &v
}

// GetFavorite returns the Favorite field value if set, zero value otherwise.
func (o *Report) GetFavorite() bool {
...
// and a boolean to check if the value has been set.
func (o *Report) GetFavoriteOk() (*bool, bool) {
	if o == nil || IsNil(o.Favorite) {
		return nil, false
	}
...
func (o *Report) HasFavorite() bool {
	if o != nil && !IsNil(o.Favorite) {
		return true
	}
...
func (o *Report) SetFavorite(v bool) {
	o.Favorite = &v
}

// GetFavorites returns the Favorites field value if set, zero value otherwise.
func (o *Report) GetFavorites() []string {
...
// and a boolean to check if the value has been set.
func (o *Report) GetFavoritesOk() ([]string, bool) {
	if o == nil || IsNil(o.Favorites) {
		return nil, false
	}
...
func (o *Report) HasFavorites() bool {
	if o != nil && !IsNil(o.Favorites) {
		return true
	}
...
func (o *Report) SetFavorites(v []string) {
	o.Favorites = v
}
...
func (o *Report) GetLastUpdatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Report) GetLastUpdatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *Report) HasLastUpdatedBy() bool {
	if o != nil && !IsNil(o.LastUpdatedBy) {
		return true
	}
...
func (o *Report) SetLastUpdatedBy(v AggregateDataExchangeCreatedBy) {
	o.LastUpdatedBy = &v
}
...
func (o *Report) GetPublicAccess() string {
...
// and a boolean to check if the value has been set.
func (o *Report) GetPublicAccessOk() (*string, bool) {
	if o == nil || IsNil(o.PublicAccess) {
		return nil, false
	}
...
func (o *Report) HasPublicAccess() bool {
	if o != nil && !IsNil(o.PublicAccess) {
		return true
	}
...
func (o *Report) SetPublicAccess(v string) {
	o.PublicAccess = &v
}

// GetRelativePeriods returns the RelativePeriods field value if set, zero value otherwise.
func (o *Report) GetRelativePeriods() RelativePeriods {
...
// and a boolean to check if the value has been set.
func (o *Report) GetRelativePeriodsOk() (*RelativePeriods, bool) {
	if o == nil || IsNil(o.RelativePeriods) {
		return nil, false
	}
...
func (o *Report) HasRelativePeriods() bool {
	if o != nil && !IsNil(o.RelativePeriods) {
		return true
	}
...
func (o *Report) SetRelativePeriods(v RelativePeriods) {
	o.RelativePeriods = &v
}

// GetReportParams returns the ReportParams field value if set, zero value otherwise.
func (o *Report) GetReportParams() ReportingParams {
...
// and a boolean to check if the value has been set.
func (o *Report) GetReportParamsOk() (*ReportingParams, bool) {
	if o == nil || IsNil(o.ReportParams) {
		return nil, false
	}
...
func (o *Report) HasReportParams() bool {
	if o != nil && !IsNil(o.ReportParams) {
		return true
	}
...
func (o *Report) SetReportParams(v ReportingParams) {
	o.ReportParams = &v
}

// GetSharing returns the Sharing field value if set, zero value otherwise.
func (o *Report) GetSharing() Sharing {
...
// and a boolean to check if the value has been set.
func (o *Report) GetSharingOk() (*Sharing, bool) {
	if o == nil || IsNil(o.Sharing) {
		return nil, false
	}
...
func (o *Report) SetSharing(v Sharing) {
	o.Sharing = &v
}

// GetTranslations returns the Translations field value if set, zero value otherwise.
func (o *Report) GetTranslations() []Translation {
...
// and a boolean to check if the value has been set.
func (o *Report) GetTranslationsOk() ([]Translation, bool) {
	if o == nil || IsNil(o.Translations) {
		return nil, false
	}
...
func (o *Report) HasTranslations() bool {
	if o != nil && !IsNil(o.Translations) {
		return true
	}
...
func (o *Report) SetTranslations(v []Translation) {
	o.Translations = v
}
...
func (o *Report) GetUser() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Report) GetUserOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *Report) SetUser(v AggregateDataExchangeCreatedBy) {
	o.User = &v
}

// GetUserAccesses returns the UserAccesses field value if set, zero value otherwise.
func (o *Report) GetUserAccesses() []LegacyUserAccess {
...
// and a boolean to check if the value has been set.
func (o *Report) GetUserAccessesOk() ([]LegacyUserAccess, bool) {
	if o == nil || IsNil(o.UserAccesses) {
		return nil, false
	}
...
func (o *Report) HasUserAccesses() bool {
	if o != nil && !IsNil(o.UserAccesses) {
		return true
	}
...
func (o *Report) SetUserAccesses(v []LegacyUserAccess) {
	o.UserAccesses = v
}

// GetUserGroupAccesses returns the UserGroupAccesses field value if set, zero value otherwise.
func (o *Report) GetUserGroupAccesses() []LegacyUserGroupAccess {
...
// and a boolean to check if the value has been set.
func (o *Report) GetUserGroupAccessesOk() ([]LegacyUserGroupAccess, bool) {
	if o == nil || IsNil(o.UserGroupAccesses) {
		return nil, false
	}
...
func (o *Report) HasUserGroupAccesses() bool {
	if o != nil && !IsNil(o.UserGroupAccesses) {
		return true
	}
...
func (o *Report) SetUserGroupAccesses(v []LegacyUserGroupAccess) {
	o.UserGroupAccesses = v
}

// GetVisualization returns the Visualization field value if set, zero value otherwise.
func (o *Report) GetVisualization() DashboardItemVisualization {
...
// and a boolean to check if the value has been set.
func (o *Report) GetVisualizationOk() (*DashboardItemVisualization, bool) {
	if o == nil || IsNil(o.Visualization) {
		return nil, false
	}
...
func (o *Report) HasVisualization() bool {
	if o != nil && !IsNil(o.Visualization) {
		return true
	}
...
func (o *Report) SetVisualization(v DashboardItemVisualization) {
	o.Visualization = &v
}
