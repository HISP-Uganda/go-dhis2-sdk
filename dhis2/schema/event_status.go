...
const (
	...
	EVENTSTATUS_VISITED   EventStatus = "VISITED"
	EVENTSTATUS_SCHEDULE  EventStatus = "SCHEDULE"
	EVENTSTATUS_OVERDUE   EventStatus = "OVERDUE"
	EVENTSTATUS_SKIPPED   EventStatus = "SKIPPED"
)
