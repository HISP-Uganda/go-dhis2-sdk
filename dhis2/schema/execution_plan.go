...
func (o *ExecutionPlan) GetPlan() any {
...
// and a boolean to check if the value has been set.
func (o *ExecutionPlan) GetPlanOk() (*any, bool) {
	if o == nil || IsNil(o.Plan) {
		return nil, false
	}
	return o.Plan, true
...
// SetPlan gets a reference to the given any and assigns it to the Plan field.
func (o *ExecutionPlan) SetPlan(v any) {
	o.Plan = &v
}
