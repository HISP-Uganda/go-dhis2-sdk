...
func NewCustomDataEntryFormDto(displayDensity string) *CustomDataEntryFormDto {
...
func (o *CustomDataEntryFormDto) GetDisplayDensity() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CustomDataEntryFormDto) GetDisplayDensityOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CustomDataEntryFormDto) SetDisplayDensity(v string) {
	o.DisplayDensity = v
}
