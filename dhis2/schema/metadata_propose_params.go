...
func (o *MetadataProposeParams) GetChange() map[string]interface{} {
...
func (o *MetadataProposeParams) GetChangeOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Change) {
...
func (o *MetadataProposeParams) SetChange(v map[string]interface{}) {
	o.Change = v
}
