...
func NewOrgUnitInfo(featureType string) *OrgUnitInfo {
	this := OrgUnitInfo{}
...
func (o *OrgUnitInfo) GetFeatureType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OrgUnitInfo) GetFeatureTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrgUnitInfo) SetFeatureType(v string) {
	o.FeatureType = v
}
