...
func (o *UserMessage) GetUser() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *UserMessage) GetUserOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *UserMessage) SetUser(v AggregateDataExchangeCreatedBy) {
	o.User = &v
}
