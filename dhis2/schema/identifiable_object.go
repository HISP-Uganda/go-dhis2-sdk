...
func (o *IdentifiableObject) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *IdentifiableObject) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *IdentifiableObject) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *IdentifiableObject) SetId(v string) {
	o.Id = &v
}
