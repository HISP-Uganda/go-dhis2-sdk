...
type OrgUnitMergeQuery struct {
	DataApprovalMergeStrategy DataMergeStrategy `json:"dataApprovalMergeStrategy"`
	DataValueMergeStrategy    DataMergeStrategy `json:"dataValueMergeStrategy"`
...
func NewOrgUnitMergeQuery(dataApprovalMergeStrategy DataMergeStrategy, dataValueMergeStrategy DataMergeStrategy) *OrgUnitMergeQuery {
...
func (o *OrgUnitMergeQuery) GetDataApprovalMergeStrategy() DataMergeStrategy {
	if o == nil {
...
func (o *OrgUnitMergeQuery) GetDataApprovalMergeStrategyOk() (*DataMergeStrategy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrgUnitMergeQuery) SetDataApprovalMergeStrategy(v DataMergeStrategy) {
	o.DataApprovalMergeStrategy = v
}

// GetDataValueMergeStrategy returns the DataValueMergeStrategy field value
func (o *OrgUnitMergeQuery) GetDataValueMergeStrategy() DataMergeStrategy {
	if o == nil {
		var ret DataMergeStrategy
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OrgUnitMergeQuery) GetDataValueMergeStrategyOk() (*DataMergeStrategy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrgUnitMergeQuery) SetDataValueMergeStrategy(v DataMergeStrategy) {
