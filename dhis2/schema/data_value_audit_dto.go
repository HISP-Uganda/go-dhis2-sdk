...
func NewDataValueAuditDto(auditType string) *DataValueAuditDto {
...
func (o *DataValueAuditDto) GetAuditType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DataValueAuditDto) GetAuditTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataValueAuditDto) SetAuditType(v string) {
	o.AuditType = v
}
