...
func (o *Error) GetTrackerType() string {
...
// and a boolean to check if the value has been set.
func (o *Error) GetTrackerTypeOk() (*string, bool) {
	if o == nil || IsNil(o.TrackerType) {
		return nil, false
	}
...
func (o *Error) HasTrackerType() bool {
	if o != nil && !IsNil(o.TrackerType) {
		return true
	}
...
func (o *Error) SetTrackerType(v string) {
	o.TrackerType = &v
}

// GetUid returns the Uid field value if set, zero value otherwise.
func (o *Error) GetUid() string {
...
// and a boolean to check if the value has been set.
func (o *Error) GetUidOk() (*string, bool) {
	if o == nil || IsNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
