...
func NewSimpleDimension(parent string) *SimpleDimension {
...
func (o *SimpleDimension) HasDimension() bool {
	if o != nil && !IsNil(o.Dimension) {
		return true
	}
...
func (o *SimpleDimension) GetParent() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SimpleDimension) GetParentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SimpleDimension) SetParent(v string) {
	o.Parent = v
}
...
func (o *SimpleDimension) HasValues() bool {
	if o != nil && !IsNil(o.Values) {
		return true
	}
