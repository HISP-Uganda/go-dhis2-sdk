...
func NewGridHeader(valueType string) *GridHeader {
	this := GridHeader{}
...
func (o *GridHeader) GetValueType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GridHeader) GetValueTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GridHeader) SetValueType(v string) {
	o.ValueType = v
}
