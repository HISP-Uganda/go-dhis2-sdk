...
type SharingInfo struct {
	Meta   *SharingMeta   `json:"meta,omitempty"`
...
func (o *SharingInfo) GetMeta() SharingMeta {
...
func (o *SharingInfo) GetMetaOk() (*SharingMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
// SetMeta gets a reference to the given SharingMeta and assigns it to the Meta field.
func (o *SharingInfo) SetMeta(v SharingMeta) {
	o.Meta = &v
}
