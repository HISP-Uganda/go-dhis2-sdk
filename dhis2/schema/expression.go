...
func NewExpression(missingValueStrategy string) *Expression {
	this := Expression{}
...
func (o *Expression) GetMissingValueStrategy() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Expression) GetMissingValueStrategyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Expression) SetMissingValueStrategy(v string) {
