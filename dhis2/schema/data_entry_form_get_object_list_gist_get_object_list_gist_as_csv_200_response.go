...
// []map[string]interface{}AsDataEntryFormGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in DataEntryFormGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsDataEntryFormGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) DataEntryFormGetObjectListGistGetObjectListGistAsCsv200Response {
	return DataEntryFormGetObjectListGistGetObjectListGistAsCsv200Response{
