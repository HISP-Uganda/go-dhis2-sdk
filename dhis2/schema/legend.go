...
func (o *Legend) GetCreatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetCreatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *Legend) SetCreatedBy(v AggregateDataExchangeCreatedBy) {
	o.CreatedBy = &v
}
...
func (o *Legend) GetExternalAccess() bool {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetExternalAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.ExternalAccess) {
		return nil, false
	}
...
func (o *Legend) HasExternalAccess() bool {
	if o != nil && !IsNil(o.ExternalAccess) {
		return true
	}
...
func (o *Legend) SetExternalAccess(v bool) {
	o.ExternalAccess = &v
}
...
func (o *Legend) GetLastUpdatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetLastUpdatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *Legend) SetLastUpdatedBy(v AggregateDataExchangeCreatedBy) {
	o.LastUpdatedBy = &v
}
...
func (o *Legend) GetPublicAccess() string {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetPublicAccessOk() (*string, bool) {
	if o == nil || IsNil(o.PublicAccess) {
		return nil, false
	}
...
func (o *Legend) HasPublicAccess() bool {
	if o != nil && !IsNil(o.PublicAccess) {
		return true
	}
...
func (o *Legend) SetPublicAccess(v string) {
	o.PublicAccess = &v
}
...
func (o *Legend) GetUser() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetUserOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *Legend) SetUser(v AggregateDataExchangeCreatedBy) {
	o.User = &v
}

// GetUserAccesses returns the UserAccesses field value if set, zero value otherwise.
func (o *Legend) GetUserAccesses() []LegacyUserAccess {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetUserAccessesOk() ([]LegacyUserAccess, bool) {
	if o == nil || IsNil(o.UserAccesses) {
		return nil, false
	}
...
func (o *Legend) HasUserAccesses() bool {
	if o != nil && !IsNil(o.UserAccesses) {
		return true
	}
...
func (o *Legend) SetUserAccesses(v []LegacyUserAccess) {
	o.UserAccesses = v
}

// GetUserGroupAccesses returns the UserGroupAccesses field value if set, zero value otherwise.
func (o *Legend) GetUserGroupAccesses() []LegacyUserGroupAccess {
...
// and a boolean to check if the value has been set.
func (o *Legend) GetUserGroupAccessesOk() ([]LegacyUserGroupAccess, bool) {
	if o == nil || IsNil(o.UserGroupAccesses) {
		return nil, false
	}
...
func (o *Legend) HasUserGroupAccesses() bool {
	if o != nil && !IsNil(o.UserGroupAccesses) {
		return true
	}
...
func (o *Legend) SetUserGroupAccesses(v []LegacyUserGroupAccess) {
