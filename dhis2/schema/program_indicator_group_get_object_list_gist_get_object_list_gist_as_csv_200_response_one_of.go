...
type ProgramIndicatorGroupGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf struct {
	...
	ProgramIndicatorGroups []map[string]interface{} `json:"programIndicatorGroups,omitempty"`
}
...
func (o *ProgramIndicatorGroupGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) GetProgramIndicatorGroups() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ProgramIndicatorGroupGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) GetProgramIndicatorGroupsOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.ProgramIndicatorGroups) {
		return nil, false
	}
...
// SetProgramIndicatorGroups gets a reference to the given []map[string]interface{} and assigns it to the ProgramIndicatorGroups field.
func (o *ProgramIndicatorGroupGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) SetProgramIndicatorGroups(v []map[string]interface{}) {
