...
func (o *ProfileItem) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *ProfileItem) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ProfileItem) SetId(v string) {
	o.Id = &v
}

// GetLabel returns the Label field value if set, zero value otherwise.
func (o *ProfileItem) GetLabel() string {
...
// and a boolean to check if the value has been set.
func (o *ProfileItem) GetLabelOk() (*string, bool) {
	if o == nil || IsNil(o.Label) {
		return nil, false
	}
	return o.Label, true
...
func (o *ProfileItem) HasLabel() bool {
	if o != nil && !IsNil(o.Label) {
		return true
	}
...
func (o *ProfileItem) SetLabel(v string) {
	o.Label = &v
}

// GetValue returns the Value field value if set, zero value otherwise.
func (o *ProfileItem) GetValue() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ProfileItem) GetValueOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Value) {
...
func (o *ProfileItem) HasValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *ProfileItem) SetValue(v map[string]interface{}) {
	o.Value = v
}
