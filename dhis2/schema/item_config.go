...
func NewItemConfig(insertPosition string) *ItemConfig {
	this := ItemConfig{}
...
func (o *ItemConfig) GetInsertPosition() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ItemConfig) GetInsertPositionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ItemConfig) SetInsertPosition(v string) {
	o.InsertPosition = v
}
