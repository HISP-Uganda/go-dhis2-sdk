...
// checks if the ReportingRate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportingRate{}

// ReportingRate struct for ReportingRate
...
type _ReportingRate ReportingRate

// NewReportingRate instantiates a new ReportingRate object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReportingRate(aggregationType string, metric string) *ReportingRate {
	this := ReportingRate{}
...
// NewReportingRateWithDefaults instantiates a new ReportingRate object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewReportingRateWithDefaults() *ReportingRate {
	this := ReportingRate{}
	return &this
}

// GetAccess returns the Access field value if set, zero value otherwise.
func (o *ReportingRate) GetAccess() Access {
...
func (o *ReportingRate) GetAccessOk() (*Access, bool) {
	if o == nil || IsNil(o.Access) {
		return nil, false
	}
...
func (o *ReportingRate) HasAccess() bool {
	if o != nil && !IsNil(o.Access) {
		return true
	}
...
func (o *ReportingRate) SetAccess(v Access) {
	o.Access = &v
}

// GetAggregationType returns the AggregationType field value
func (o *ReportingRate) GetAggregationType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetAggregationTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ReportingRate) SetAggregationType(v string) {
	o.AggregationType = v
}

// GetAttributeValues returns the AttributeValues field value if set, zero value otherwise.
func (o *ReportingRate) GetAttributeValues() []AttributeValue {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetAttributeValuesOk() ([]AttributeValue, bool) {
	if o == nil || IsNil(o.AttributeValues) {
		return nil, false
	}
...
func (o *ReportingRate) HasAttributeValues() bool {
	if o != nil && !IsNil(o.AttributeValues) {
		return true
	}
...
func (o *ReportingRate) SetAttributeValues(v []AttributeValue) {
	o.AttributeValues = v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *ReportingRate) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *ReportingRate) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ReportingRate) SetCode(v string) {
	o.Code = &v
}

// GetCreated returns the Created field value if set, zero value otherwise.
func (o *ReportingRate) GetCreated() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetCreatedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Created) {
		return nil, false
	}
...
func (o *ReportingRate) HasCreated() bool {
	if o != nil && !IsNil(o.Created) {
		return true
	}
...
func (o *ReportingRate) SetCreated(v time.Time) {
	o.Created = &v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *ReportingRate) GetCreatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetCreatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *ReportingRate) HasCreatedBy() bool {
	if o != nil && !IsNil(o.CreatedBy) {
		return true
	}
...
func (o *ReportingRate) SetCreatedBy(v AggregateDataExchangeCreatedBy) {
	o.CreatedBy = &v
}

// GetDataSet returns the DataSet field value if set, zero value otherwise.
func (o *ReportingRate) GetDataSet() DataApprovalWorkflowDataSetsInner {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetDataSetOk() (*DataApprovalWorkflowDataSetsInner, bool) {
	if o == nil || IsNil(o.DataSet) {
		return nil, false
	}
...
func (o *ReportingRate) HasDataSet() bool {
	if o != nil && !IsNil(o.DataSet) {
		return true
	}
...
func (o *ReportingRate) SetDataSet(v DataApprovalWorkflowDataSetsInner) {
	o.DataSet = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *ReportingRate) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *ReportingRate) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *ReportingRate) SetDescription(v string) {
	o.Description = &v
}

// GetDisplayDescription returns the DisplayDescription field value if set, zero value otherwise.
func (o *ReportingRate) GetDisplayDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetDisplayDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayDescription) {
		return nil, false
	}
...
func (o *ReportingRate) HasDisplayDescription() bool {
	if o != nil && !IsNil(o.DisplayDescription) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetDisplayFormNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayFormName) {
		return nil, false
	}
...
func (o *ReportingRate) HasDisplayFormName() bool {
	if o != nil && !IsNil(o.DisplayFormName) {
		return true
	}
...
func (o *ReportingRate) SetDisplayFormName(v string) {
	o.DisplayFormName = &v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *ReportingRate) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *ReportingRate) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *ReportingRate) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetDisplayShortName returns the DisplayShortName field value if set, zero value otherwise.
func (o *ReportingRate) GetDisplayShortName() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetDisplayShortNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayShortName) {
		return nil, false
	}
...
func (o *ReportingRate) HasDisplayShortName() bool {
	if o != nil && !IsNil(o.DisplayShortName) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetExternalAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.ExternalAccess) {
		return nil, false
	}
...
func (o *ReportingRate) HasExternalAccess() bool {
	if o != nil && !IsNil(o.ExternalAccess) {
		return true
	}
...
func (o *ReportingRate) SetExternalAccess(v bool) {
	o.ExternalAccess = &v
}

// GetFavorite returns the Favorite field value if set, zero value otherwise.
func (o *ReportingRate) GetFavorite() bool {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetFavoriteOk() (*bool, bool) {
	if o == nil || IsNil(o.Favorite) {
		return nil, false
	}
...
func (o *ReportingRate) HasFavorite() bool {
	if o != nil && !IsNil(o.Favorite) {
		return true
	}
...
func (o *ReportingRate) SetFavorite(v bool) {
	o.Favorite = &v
}

// GetFavorites returns the Favorites field value if set, zero value otherwise.
func (o *ReportingRate) GetFavorites() []string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetFavoritesOk() ([]string, bool) {
	if o == nil || IsNil(o.Favorites) {
		return nil, false
	}
...
func (o *ReportingRate) HasFavorites() bool {
	if o != nil && !IsNil(o.Favorites) {
		return true
	}
...
func (o *ReportingRate) SetFavorites(v []string) {
	o.Favorites = v
}

// GetFormName returns the FormName field value if set, zero value otherwise.
func (o *ReportingRate) GetFormName() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetFormNameOk() (*string, bool) {
	if o == nil || IsNil(o.FormName) {
		return nil, false
	}
...
func (o *ReportingRate) HasFormName() bool {
	if o != nil && !IsNil(o.FormName) {
		return true
	}
...
func (o *ReportingRate) SetFormName(v string) {
	o.FormName = &v
}

// GetHref returns the Href field value if set, zero value otherwise.
func (o *ReportingRate) GetHref() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetHrefOk() (*string, bool) {
	if o == nil || IsNil(o.Href) {
		return nil, false
	}
	return o.Href, true
...
func (o *ReportingRate) HasHref() bool {
	if o != nil && !IsNil(o.Href) {
		return true
	}
...
func (o *ReportingRate) SetHref(v string) {
	o.Href = &v
}

// GetLastUpdated returns the LastUpdated field value if set, zero value otherwise.
func (o *ReportingRate) GetLastUpdated() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetLastUpdatedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastUpdated) {
		return nil, false
	}
...
func (o *ReportingRate) HasLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *ReportingRate) SetLastUpdated(v time.Time) {
	o.LastUpdated = &v
}

// GetLastUpdatedBy returns the LastUpdatedBy field value if set, zero value otherwise.
func (o *ReportingRate) GetLastUpdatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetLastUpdatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *ReportingRate) HasLastUpdatedBy() bool {
	if o != nil && !IsNil(o.LastUpdatedBy) {
		return true
	}
...
func (o *ReportingRate) SetLastUpdatedBy(v AggregateDataExchangeCreatedBy) {
	o.LastUpdatedBy = &v
}

// GetLegendSet returns the LegendSet field value if set, zero value otherwise.
func (o *ReportingRate) GetLegendSet() CategoryLegendSet {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetLegendSetOk() (*CategoryLegendSet, bool) {
	if o == nil || IsNil(o.LegendSet) {
		return nil, false
	}
...
func (o *ReportingRate) HasLegendSet() bool {
	if o != nil && !IsNil(o.LegendSet) {
		return true
	}
...
func (o *ReportingRate) SetLegendSet(v CategoryLegendSet) {
	o.LegendSet = &v
}

// GetMetric returns the Metric field value
func (o *ReportingRate) GetMetric() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetMetricOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ReportingRate) SetMetric(v string) {
	o.Metric = v
}

// GetPublicAccess returns the PublicAccess field value if set, zero value otherwise.
func (o *ReportingRate) GetPublicAccess() string {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetPublicAccessOk() (*string, bool) {
	if o == nil || IsNil(o.PublicAccess) {
		return nil, false
	}
...
func (o *ReportingRate) HasPublicAccess() bool {
	if o != nil && !IsNil(o.PublicAccess) {
		return true
	}
...
func (o *ReportingRate) SetPublicAccess(v string) {
	o.PublicAccess = &v
}

// GetQueryMods returns the QueryMods field value if set, zero value otherwise.
func (o *ReportingRate) GetQueryMods() QueryModifiers {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetQueryModsOk() (*QueryModifiers, bool) {
	if o == nil || IsNil(o.QueryMods) {
		return nil, false
	}
...
func (o *ReportingRate) HasQueryMods() bool {
	if o != nil && !IsNil(o.QueryMods) {
		return true
	}
...
func (o *ReportingRate) SetQueryMods(v QueryModifiers) {
	o.QueryMods = &v
}

// GetSharing returns the Sharing field value if set, zero value otherwise.
func (o *ReportingRate) GetSharing() Sharing {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetSharingOk() (*Sharing, bool) {
	if o == nil || IsNil(o.Sharing) {
		return nil, false
	}
...
func (o *ReportingRate) HasSharing() bool {
	if o != nil && !IsNil(o.Sharing) {
		return true
	}
...
func (o *ReportingRate) SetSharing(v Sharing) {
	o.Sharing = &v
}

// GetTranslations returns the Translations field value if set, zero value otherwise.
func (o *ReportingRate) GetTranslations() []Translation {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetTranslationsOk() ([]Translation, bool) {
	if o == nil || IsNil(o.Translations) {
		return nil, false
	}
...
func (o *ReportingRate) HasTranslations() bool {
	if o != nil && !IsNil(o.Translations) {
		return true
	}
...
func (o *ReportingRate) SetTranslations(v []Translation) {
	o.Translations = v
}

// GetUser returns the User field value if set, zero value otherwise.
func (o *ReportingRate) GetUser() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetUserOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *ReportingRate) HasUser() bool {
	if o != nil && !IsNil(o.User) {
		return true
	}
...
func (o *ReportingRate) SetUser(v AggregateDataExchangeCreatedBy) {
	o.User = &v
}

// GetUserAccesses returns the UserAccesses field value if set, zero value otherwise.
func (o *ReportingRate) GetUserAccesses() []LegacyUserAccess {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetUserAccessesOk() ([]LegacyUserAccess, bool) {
	if o == nil || IsNil(o.UserAccesses) {
		return nil, false
	}
...
func (o *ReportingRate) HasUserAccesses() bool {
	if o != nil && !IsNil(o.UserAccesses) {
		return true
	}
...
func (o *ReportingRate) SetUserAccesses(v []LegacyUserAccess) {
	o.UserAccesses = v
}

// GetUserGroupAccesses returns the UserGroupAccesses field value if set, zero value otherwise.
func (o *ReportingRate) GetUserGroupAccesses() []LegacyUserGroupAccess {
...
// and a boolean to check if the value has been set.
func (o *ReportingRate) GetUserGroupAccessesOk() ([]LegacyUserGroupAccess, bool) {
	if o == nil || IsNil(o.UserGroupAccesses) {
		return nil, false
	}
...
func (o *ReportingRate) HasUserGroupAccesses() bool {
	if o != nil && !IsNil(o.UserGroupAccesses) {
		return true
	}
...
func (o *ReportingRate) SetUserGroupAccesses(v []LegacyUserGroupAccess) {
	o.UserGroupAccesses = v
}

func (o ReportingRate) MarshalJSON() ([]byte, error) {
...
func (o ReportingRate) ToMap() (map[string]interface{}, error) {
...
func (o *ReportingRate) UnmarshalJSON(data []byte) (err error) {
	...
	varReportingRate := _ReportingRate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReportingRate)

	if err != nil {
		return err
	}

	*o = ReportingRate(varReportingRate)

	return err
}

type NullableReportingRate struct {
	value *ReportingRate
	isSet bool
}

func (v NullableReportingRate) Get() *ReportingRate {
	return v.value
}

func (v *NullableReportingRate) Set(val *ReportingRate) {
	v.value = val
	v.isSet = true
}

func (v NullableReportingRate) IsSet() bool {
	return v.isSet
}

func (v *NullableReportingRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportingRate(val *ReportingRate) *NullableReportingRate {
	return &NullableReportingRate{value: val, isSet: true}
}

func (v NullableReportingRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportingRate) UnmarshalJSON(src []byte) error {
	v.isSet = true
