...
type OutboundMessageResponseSummary struct {
	BatchType       DeliveryChannel            `json:"batchType"`
	ErrorMessage    *string                    `json:"errorMessage,omitempty"`
	Failed          int32                      `json:"failed"`
	Pending         int32                      `json:"pending"`
	ResponseMessage *string                    `json:"responseMessage,omitempty"`
	Sent            int32                      `json:"sent"`
	Status          OutboundMessageBatchStatus `json:"status"`
...
func NewOutboundMessageResponseSummary(batchType DeliveryChannel, failed int32, pending int32, sent int32, status OutboundMessageBatchStatus, total int32) *OutboundMessageResponseSummary {
...
func (o *OutboundMessageResponseSummary) GetBatchType() DeliveryChannel {
	if o == nil {
...
func (o *OutboundMessageResponseSummary) GetBatchTypeOk() (*DeliveryChannel, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OutboundMessageResponseSummary) SetBatchType(v DeliveryChannel) {
	o.BatchType = v
}
...
func (o *OutboundMessageResponseSummary) GetStatus() OutboundMessageBatchStatus {
	if o == nil {
		var ret OutboundMessageBatchStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutboundMessageResponseSummary) GetStatusOk() (*OutboundMessageBatchStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OutboundMessageResponseSummary) SetStatus(v OutboundMessageBatchStatus) {
	o.Status = v
}
