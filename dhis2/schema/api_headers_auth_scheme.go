...
func (o *ApiHeadersAuthScheme) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *ApiHeadersAuthScheme) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *ApiHeadersAuthScheme) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *ApiHeadersAuthScheme) SetType(v string) {
	o.Type = &v
}
