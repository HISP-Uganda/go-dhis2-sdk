...
// []map[string]interface{}AsSqlViewGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in SqlViewGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsSqlViewGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) SqlViewGetObjectListGistGetObjectListGistAsCsv200Response {
	return SqlViewGetObjectListGistGetObjectListGistAsCsv200Response{
