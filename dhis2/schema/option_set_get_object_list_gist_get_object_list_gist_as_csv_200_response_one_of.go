...
type OptionSetGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf struct {
	...
	OptionSets []map[string]interface{} `json:"optionSets,omitempty"`
}
...
func (o *OptionSetGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) GetOptionSets() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *OptionSetGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) GetOptionSetsOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.OptionSets) {
		return nil, false
	}
...
// SetOptionSets gets a reference to the given []map[string]interface{} and assigns it to the OptionSets field.
func (o *OptionSetGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) SetOptionSets(v []map[string]interface{}) {
	o.OptionSets = v
}
