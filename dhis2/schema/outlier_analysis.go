...
type OutlierAnalysis struct {
	...
	OutlierMethod       string       `json:"outlierMethod"`
...
func NewOutlierAnalysis(normalizationMethod string, outlierMethod string) *OutlierAnalysis {
...
func (o *OutlierAnalysis) GetNormalizationMethod() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutlierAnalysis) GetNormalizationMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OutlierAnalysis) SetNormalizationMethod(v string) {
	o.NormalizationMethod = v
}

// GetOutlierMethod returns the OutlierMethod field value
func (o *OutlierAnalysis) GetOutlierMethod() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutlierAnalysis) GetOutlierMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OutlierAnalysis) SetOutlierMethod(v string) {
	o.OutlierMethod = v
}
