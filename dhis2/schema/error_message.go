...
func NewErrorMessage(errorCode ErrorCode) *ErrorMessage {
	this := ErrorMessage{}
...
func (o *ErrorMessage) GetArgs() []string {
...
func (o *ErrorMessage) GetArgsOk() ([]string, bool) {
	if o == nil || IsNil(o.Args) {
		return nil, false
	}
	return o.Args, true
...
func (o *ErrorMessage) HasArgs() bool {
	if o != nil && !IsNil(o.Args) {
		return true
	}
...
func (o *ErrorMessage) SetArgs(v []string) {
	o.Args = v
}

// GetErrorCode returns the ErrorCode field value
func (o *ErrorMessage) GetErrorCode() ErrorCode {
	if o == nil {
		var ret ErrorCode
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ErrorMessage) GetErrorCodeOk() (*ErrorCode, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorMessage) SetErrorCode(v ErrorCode) {
	o.ErrorCode = v
}
