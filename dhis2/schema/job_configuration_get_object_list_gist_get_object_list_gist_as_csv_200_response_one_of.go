...
type JobConfigurationGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf struct {
	...
	JobConfigurations []map[string]interface{} `json:"jobConfigurations,omitempty"`
}
...
func (o *JobConfigurationGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) GetJobConfigurations() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *JobConfigurationGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) GetJobConfigurationsOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.JobConfigurations) {
		return nil, false
	}
...
// SetJobConfigurations gets a reference to the given []map[string]interface{} and assigns it to the JobConfigurations field.
func (o *JobConfigurationGetObjectListGistGetObjectListGistAsCsv200ResponseOneOf) SetJobConfigurations(v []map[string]interface{}) {
