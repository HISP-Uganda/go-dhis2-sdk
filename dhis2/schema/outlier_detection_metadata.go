...
type OutlierDetectionMetadata struct {
	Algorithm     OutlierDetectionAlgorithm `json:"algorithm"`
...
func NewOutlierDetectionMetadata(algorithm OutlierDetectionAlgorithm, orderBy Order) *OutlierDetectionMetadata {
...
func (o *OutlierDetectionMetadata) GetAlgorithm() OutlierDetectionAlgorithm {
	if o == nil {
		var ret OutlierDetectionAlgorithm
		return ret
	}
...
func (o *OutlierDetectionMetadata) GetAlgorithmOk() (*OutlierDetectionAlgorithm, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OutlierDetectionMetadata) SetAlgorithm(v OutlierDetectionAlgorithm) {
	o.Algorithm = v
}
...
func (o *OutlierDetectionMetadata) GetOrderBy() Order {
	if o == nil {
		var ret Order
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OutlierDetectionMetadata) GetOrderByOk() (*Order, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OutlierDetectionMetadata) SetOrderBy(v Order) {
	o.OrderBy = v
}
