...
func NewEventFilterInfo(assignedUserMode string, eventStatus string) *EventFilterInfo {
...
func (o *EventFilterInfo) GetAssignedUserMode() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *EventFilterInfo) GetAssignedUserModeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventFilterInfo) SetAssignedUserMode(v string) {
...
func (o *EventFilterInfo) GetEventStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventFilterInfo) GetEventStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventFilterInfo) SetEventStatus(v string) {
	o.EventStatus = v
}
