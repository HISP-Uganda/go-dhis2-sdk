...
func NewQueryModifiers(aggregationType string, periodOffset int32, valueType string) *QueryModifiers {
	this := QueryModifiers{}
...
func (o *QueryModifiers) GetAggregationType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *QueryModifiers) GetAggregationTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *QueryModifiers) SetAggregationType(v string) {
	o.AggregationType = v
}
...
func (o *QueryModifiers) GetValueType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *QueryModifiers) GetValueTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *QueryModifiers) SetValueType(v string) {
	o.ValueType = v
}
