...
// App struct for App
type App struct {
	Activities          *AppActivities `json:"activities,omitempty"`
	AppState            string         `json:"appState"`
	AppStorageSource    string         `json:"appStorageSource"`
...
func NewApp(appState string, appStorageSource string, appType string) *App {
	this := App{}
...
// SetActivities gets a reference to the given AppActivities and assigns it to the Activities field.
func (o *App) SetActivities(v AppActivities) {
	o.Activities = &v
}

// GetAppState returns the AppState field value
func (o *App) GetAppState() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *App) GetAppStateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *App) SetAppState(v string) {
	o.AppState = v
}

// GetAppStorageSource returns the AppStorageSource field value
func (o *App) GetAppStorageSource() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *App) GetAppStorageSourceOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *App) SetAppStorageSource(v string) {
