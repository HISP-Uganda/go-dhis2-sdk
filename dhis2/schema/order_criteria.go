...
func NewOrderCriteria(direction string) *OrderCriteria {
	this := OrderCriteria{}
...
func (o *OrderCriteria) GetDirection() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OrderCriteria) GetDirectionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrderCriteria) SetDirection(v string) {
	o.Direction = v
}
