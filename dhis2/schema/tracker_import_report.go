...
type TrackerImportReport struct {
	...
	TimingsStats     *TimingsStats      `json:"timingsStats,omitempty"`
...
func NewTrackerImportReport(status string) *TrackerImportReport {
...
func (o *TrackerImportReport) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TrackerImportReport) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TrackerImportReport) SetStatus(v string) {
	o.Status = v
}

// GetTimingsStats returns the TimingsStats field value if set, zero value otherwise.
func (o *TrackerImportReport) GetTimingsStats() TimingsStats {
	if o == nil || IsNil(o.TimingsStats) {
		var ret TimingsStats
		return ret
	}
	return *o.TimingsStats
}

// GetTimingsStatsOk returns a tuple with the TimingsStats field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TrackerImportReport) GetTimingsStatsOk() (*TimingsStats, bool) {
	if o == nil || IsNil(o.TimingsStats) {
		return nil, false
	}
	return o.TimingsStats, true
}

// HasTimingsStats returns a boolean if a field has been set.
func (o *TrackerImportReport) HasTimingsStats() bool {
	if o != nil && !IsNil(o.TimingsStats) {
		return true
	}
...
// SetTimingsStats gets a reference to the given TimingsStats and assigns it to the TimingsStats field.
func (o *TrackerImportReport) SetTimingsStats(v TimingsStats) {
	o.TimingsStats = &v
}
...
func (o TrackerImportReport) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TimingsStats) {
		toSerialize["timingsStats"] = o.TimingsStats
	}
