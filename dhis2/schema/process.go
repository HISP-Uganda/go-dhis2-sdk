...
func NewProcess(duration int64, status JobProgressStatus) *Process {
	this := Process{}
...
func (o *Process) GetStatus() JobProgressStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Process) GetStatusOk() (*JobProgressStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Process) SetStatus(v JobProgressStatus) {
	o.Status = v
}
...
func (o *Process) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *Process) GetUserIdOk() (*string, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o *Process) SetUserId(v string) {
	o.UserId = &v
}
