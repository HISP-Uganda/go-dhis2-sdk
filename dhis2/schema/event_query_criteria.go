...
func NewEventQueryCriteria(assignedUserMode AssignedUserSelectionMode, ouMode OrganisationUnitSelectionMode, status EventStatus) *EventQueryCriteria {
...
func (o *EventQueryCriteria) GetAssignedUserMode() AssignedUserSelectionMode {
	if o == nil {
...
func (o *EventQueryCriteria) GetAssignedUserModeOk() (*AssignedUserSelectionMode, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventQueryCriteria) SetAssignedUserMode(v AssignedUserSelectionMode) {
...
func (o *EventQueryCriteria) GetOuMode() OrganisationUnitSelectionMode {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *EventQueryCriteria) GetOuModeOk() (*OrganisationUnitSelectionMode, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventQueryCriteria) SetOuMode(v OrganisationUnitSelectionMode) {
	o.OuMode = v
}

// GetStatus returns the Status field value
func (o *EventQueryCriteria) GetStatus() EventStatus {
	if o == nil {
		var ret EventStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventQueryCriteria) GetStatusOk() (*EventStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventQueryCriteria) SetStatus(v EventStatus) {
	o.Status = v
}
