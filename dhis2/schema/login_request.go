...
// GetTwoFactorCode returns the TwoFactorCode field value if set, zero value otherwise.
func (o *LoginRequest) GetTwoFactorCode() string {
	if o == nil || IsNil(o.TwoFactorCode) {
		var ret string
		return ret
	}
	return *o.TwoFactorCode
}
...
// SetTwoFactorCode gets a reference to the given string and assigns it to the TwoFactorCode field.
...
func (o LoginRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TwoFactorCode) {
		toSerialize["twoFactorCode"] = o.TwoFactorCode
	}
	if !IsNil(o.Username) {
