...
func NewApprovalStatusDto(state string) *ApprovalStatusDto {
...
func (o *ApprovalStatusDto) GetState() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApprovalStatusDto) GetStateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.State, true
...
func (o *ApprovalStatusDto) SetState(v string) {
	o.State = v
}
