...
// []map[string]interface{}AsOptionGroupSetGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in OptionGroupSetGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsOptionGroupSetGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) OptionGroupSetGetObjectListGistGetObjectListGistAsCsv200Response {
	return OptionGroupSetGetObjectListGistGetObjectListGistAsCsv200Response{
