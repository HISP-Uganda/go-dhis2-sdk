...
func NewStyledObject(textMode string) *StyledObject {
	this := StyledObject{}
...
func (o *StyledObject) GetTextMode() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StyledObject) GetTextModeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *StyledObject) SetTextMode(v string) {
	o.TextMode = v
}
