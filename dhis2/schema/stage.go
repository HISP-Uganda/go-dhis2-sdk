...
func NewStage(duration int64, onFailure string, status string, totalItems int32) *Stage {
	this := Stage{}
...
func (o *Stage) GetOnFailure() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Stage) GetOnFailureOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Stage) SetOnFailure(v string) {
	o.OnFailure = v
}

// GetStatus returns the Status field value
func (o *Stage) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Stage) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Stage) SetStatus(v string) {
	o.Status = v
}
