...
type SourceParams struct {
	PeriodTypes []string `json:"periodTypes,omitempty"`
}
...
func (o *SourceParams) GetPeriodTypes() []string {
...
func (o *SourceParams) GetPeriodTypesOk() ([]string, bool) {
	if o == nil || IsNil(o.PeriodTypes) {
		return nil, false
	}
...
// SetPeriodTypes gets a reference to the given []string and assigns it to the PeriodTypes field.
func (o *SourceParams) SetPeriodTypes(v []string) {
	o.PeriodTypes = v
}
