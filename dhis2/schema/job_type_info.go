...
func NewJobTypeInfo(jobType string, schedulingType string) *JobTypeInfo {
	this := JobTypeInfo{}
...
func (o *JobTypeInfo) GetJobType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *JobTypeInfo) GetJobTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JobTypeInfo) SetJobType(v string) {
	o.JobType = v
}
...
func (o *JobTypeInfo) GetSchedulingType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *JobTypeInfo) GetSchedulingTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JobTypeInfo) SetSchedulingType(v string) {
	o.SchedulingType = v
}
