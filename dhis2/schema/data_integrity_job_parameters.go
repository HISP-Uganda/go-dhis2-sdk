...
func NewDataIntegrityJobParameters(type_ string) *DataIntegrityJobParameters {
...
func (o *DataIntegrityJobParameters) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DataIntegrityJobParameters) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *DataIntegrityJobParameters) SetType(v string) {
	o.Type = v
}
