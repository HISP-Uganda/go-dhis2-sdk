...
func NewGistPreferences(included string, transformation string) *GistPreferences {
...
func (o *GistPreferences) GetIncluded() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GistPreferences) GetIncludedOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GistPreferences) SetIncluded(v string) {
	o.Included = v
}

// GetTransformation returns the Transformation field value
func (o *GistPreferences) GetTransformation() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GistPreferences) GetTransformationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GistPreferences) SetTransformation(v string) {
	o.Transformation = v
}
