...
func (o *OAuth2ClientGetObjectList200Response) GetOAuth2Clients() []OAuth2Client {
...
// and a boolean to check if the value has been set.
func (o *OAuth2ClientGetObjectList200Response) GetOAuth2ClientsOk() ([]OAuth2Client, bool) {
	if o == nil || IsNil(o.OAuth2Clients) {
		return nil, false
	}
...
// SetOAuth2Clients gets a reference to the given []OAuth2Client and assigns it to the OAuth2Clients field.
func (o *OAuth2ClientGetObjectList200Response) SetOAuth2Clients(v []OAuth2Client) {
	o.OAuth2Clients = v
}
