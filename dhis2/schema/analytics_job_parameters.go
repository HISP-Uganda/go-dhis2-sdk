...
func (o *AnalyticsJobParameters) GetSkipTableTypes() []string {
...
// and a boolean to check if the value has been set.
func (o *AnalyticsJobParameters) GetSkipTableTypesOk() ([]string, bool) {
	if o == nil || IsNil(o.SkipTableTypes) {
		return nil, false
	}
...
func (o *AnalyticsJobParameters) SetSkipTableTypes(v []string) {
	o.SkipTableTypes = v
}
