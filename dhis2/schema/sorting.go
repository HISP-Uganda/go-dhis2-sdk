...
func NewSorting(dimension string, direction string) *Sorting {
	this := Sorting{}
...
func (o *Sorting) GetDirection() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Sorting) GetDirectionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Sorting) SetDirection(v string) {
	o.Direction = v
}
