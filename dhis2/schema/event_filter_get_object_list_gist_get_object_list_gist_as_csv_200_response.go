...
// []map[string]interface{}AsEventFilterGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in EventFilterGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsEventFilterGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) EventFilterGetObjectListGistGetObjectListGistAsCsv200Response {
	return EventFilterGetObjectListGistGetObjectListGistAsCsv200Response{
