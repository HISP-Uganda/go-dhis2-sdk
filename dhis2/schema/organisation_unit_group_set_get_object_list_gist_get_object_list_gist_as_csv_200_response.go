...
// []map[string]interface{}AsOrganisationUnitGroupSetGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in OrganisationUnitGroupSetGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsOrganisationUnitGroupSetGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) OrganisationUnitGroupSetGetObjectListGistGetObjectListGistAsCsv200Response {
	return OrganisationUnitGroupSetGetObjectListGistGetObjectListGistAsCsv200Response{
