...
// []map[string]interface{}AsRouteGetObjectListGistGetObjectListGistAsCsv200Response is a convenience function that returns []map[string]interface{} wrapped in RouteGetObjectListGistGetObjectListGistAsCsv200Response
func ArrayOfMapmapOfStringAnyAsRouteGetObjectListGistGetObjectListGistAsCsv200Response(v *[]map[string]interface{}) RouteGetObjectListGistGetObjectListGistAsCsv200Response {
	return RouteGetObjectListGistGetObjectListGistAsCsv200Response{
