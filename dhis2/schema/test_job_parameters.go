...
type TestJobParameters struct {
	...
	FailWithPolicy        FailurePolicy `json:"failWithPolicy"`
	FailWithPostCondition *bool         `json:"failWithPostCondition,omitempty"`
...
func NewTestJobParameters(failWithPolicy FailurePolicy) *TestJobParameters {
...
func (o *TestJobParameters) GetFailWithPolicy() FailurePolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TestJobParameters) GetFailWithPolicyOk() (*FailurePolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TestJobParameters) SetFailWithPolicy(v FailurePolicy) {
	o.FailWithPolicy = v
}

// GetFailWithPostCondition returns the FailWithPostCondition field value if set, zero value otherwise.
func (o *TestJobParameters) GetFailWithPostCondition() bool {
	if o == nil || IsNil(o.FailWithPostCondition) {
		var ret bool
		return ret
	}
	return *o.FailWithPostCondition
}

// GetFailWithPostConditionOk returns a tuple with the FailWithPostCondition field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TestJobParameters) GetFailWithPostConditionOk() (*bool, bool) {
	if o == nil || IsNil(o.FailWithPostCondition) {
		return nil, false
	}
	return o.FailWithPostCondition, true
}

// HasFailWithPostCondition returns a boolean if a field has been set.
func (o *TestJobParameters) HasFailWithPostCondition() bool {
	if o != nil && !IsNil(o.FailWithPostCondition) {
		return true
	}
...
// SetFailWithPostCondition gets a reference to the given bool and assigns it to the FailWithPostCondition field.
func (o *TestJobParameters) SetFailWithPostCondition(v bool) {
	o.FailWithPostCondition = &v
}
...
func (o TestJobParameters) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FailWithPostCondition) {
		toSerialize["failWithPostCondition"] = o.FailWithPostCondition
	}
