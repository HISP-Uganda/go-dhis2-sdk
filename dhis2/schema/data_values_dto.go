...
func NewDataValuesDto(lockStatus LockStatus) *DataValuesDto {
	this := DataValuesDto{}
...
func (o *DataValuesDto) GetLockStatus() LockStatus {
	if o == nil {
		var ret LockStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DataValuesDto) GetLockStatusOk() (*LockStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataValuesDto) SetLockStatus(v LockStatus) {
	o.LockStatus = v
}
