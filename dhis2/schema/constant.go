...
func (o *Constant) GetCreatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetCreatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *Constant) SetCreatedBy(v AggregateDataExchangeCreatedBy) {
	o.CreatedBy = &v
}
...
func (o *Constant) GetExternalAccess() bool {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetExternalAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.ExternalAccess) {
		return nil, false
	}
...
func (o *Constant) HasExternalAccess() bool {
	if o != nil && !IsNil(o.ExternalAccess) {
		return true
	}
...
func (o *Constant) SetExternalAccess(v bool) {
	o.ExternalAccess = &v
}
...
func (o *Constant) GetLastUpdatedBy() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetLastUpdatedByOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *Constant) SetLastUpdatedBy(v AggregateDataExchangeCreatedBy) {
	o.LastUpdatedBy = &v
}
...
func (o *Constant) GetPublicAccess() string {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetPublicAccessOk() (*string, bool) {
	if o == nil || IsNil(o.PublicAccess) {
		return nil, false
	}
...
func (o *Constant) HasPublicAccess() bool {
	if o != nil && !IsNil(o.PublicAccess) {
		return true
	}
...
func (o *Constant) SetPublicAccess(v string) {
	o.PublicAccess = &v
}
...
func (o *Constant) GetUser() AggregateDataExchangeCreatedBy {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetUserOk() (*AggregateDataExchangeCreatedBy, bool) {
	if o == nil || IsNil(o.User) {
		return nil, false
	}
	return o.User, true
...
func (o *Constant) SetUser(v AggregateDataExchangeCreatedBy) {
	o.User = &v
}

// GetUserAccesses returns the UserAccesses field value if set, zero value otherwise.
func (o *Constant) GetUserAccesses() []LegacyUserAccess {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetUserAccessesOk() ([]LegacyUserAccess, bool) {
	if o == nil || IsNil(o.UserAccesses) {
		return nil, false
	}
...
func (o *Constant) HasUserAccesses() bool {
	if o != nil && !IsNil(o.UserAccesses) {
		return true
	}
...
func (o *Constant) SetUserAccesses(v []LegacyUserAccess) {
	o.UserAccesses = v
}

// GetUserGroupAccesses returns the UserGroupAccesses field value if set, zero value otherwise.
func (o *Constant) GetUserGroupAccesses() []LegacyUserGroupAccess {
...
// and a boolean to check if the value has been set.
func (o *Constant) GetUserGroupAccessesOk() ([]LegacyUserGroupAccess, bool) {
	if o == nil || IsNil(o.UserGroupAccesses) {
		return nil, false
	}
...
func (o *Constant) HasUserGroupAccesses() bool {
	if o != nil && !IsNil(o.UserGroupAccesses) {
		return true
	}
...
func (o *Constant) SetUserGroupAccesses(v []LegacyUserGroupAccess) {
