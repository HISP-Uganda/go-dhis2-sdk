...
func NewTrackerAttribute(valueType string) *TrackerAttribute {
...
func (o *TrackerAttribute) GetCreated() string {
...
// and a boolean to check if the value has been set.
func (o *TrackerAttribute) GetCreatedOk() (*string, bool) {
	if o == nil || IsNil(o.Created) {
		return nil, false
	}
...
func (o *TrackerAttribute) HasCreated() bool {
	if o != nil && !IsNil(o.Created) {
		return true
	}
...
func (o *TrackerAttribute) SetCreated(v string) {
	o.Created = &v
}
...
func (o *TrackerAttribute) GetLastUpdated() string {
...
// and a boolean to check if the value has been set.
func (o *TrackerAttribute) GetLastUpdatedOk() (*string, bool) {
	if o == nil || IsNil(o.LastUpdated) {
		return nil, false
	}
...
func (o *TrackerAttribute) HasLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *TrackerAttribute) SetLastUpdated(v string) {
	o.LastUpdated = &v
}
...
func (o *TrackerAttribute) GetValueType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TrackerAttribute) GetValueTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TrackerAttribute) SetValueType(v string) {
	o.ValueType = v
}
