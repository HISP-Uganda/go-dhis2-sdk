...
type ErrorReport struct {
	...
	ErrorProperties []map[string]interface{} `json:"errorProperties,omitempty"`
...
func NewErrorReport(errorCode string) *ErrorReport {
	this := ErrorReport{}
...
func (o *ErrorReport) GetErrorCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ErrorReport) GetErrorCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorReport) SetErrorCode(v string) {
	o.ErrorCode = v
}
...
// GetErrorProperties returns the ErrorProperties field value if set, zero value otherwise.
func (o *ErrorReport) GetErrorProperties() []map[string]interface{} {
	if o == nil || IsNil(o.ErrorProperties) {
...
// GetErrorPropertiesOk returns a tuple with the ErrorProperties field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ErrorReport) GetErrorPropertiesOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.ErrorProperties) {
		return nil, false
	}
...
// HasErrorProperties returns a boolean if a field has been set.
func (o *ErrorReport) HasErrorProperties() bool {
	if o != nil && !IsNil(o.ErrorProperties) {
		return true
	}
...
// SetErrorProperties gets a reference to the given []map[string]interface{} and assigns it to the ErrorProperties field.
func (o *ErrorReport) SetErrorProperties(v []map[string]interface{}) {
	o.ErrorProperties = v
}
...
func (o *ErrorReport) GetValue() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ErrorReport) GetValueOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Value) {
...
func (o *ErrorReport) SetValue(v map[string]interface{}) {
	o.Value = v
}
