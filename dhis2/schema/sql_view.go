...
func NewSqlView(cacheStrategy CacheStrategy, type_ SqlViewType) *SqlView {
	this := SqlView{}
...
func (o *SqlView) GetCacheStrategy() CacheStrategy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *SqlView) GetCacheStrategyOk() (*CacheStrategy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SqlView) SetCacheStrategy(v CacheStrategy) {
	o.CacheStrategy = v
}
...
func (o *SqlView) GetCreatedBy() UserDto {
...
// and a boolean to check if the value has been set.
func (o *SqlView) GetCreatedByOk() (*UserDto, bool) {
	if o == nil || IsNil(o.CreatedBy) {
		return nil, false
	}
...
func (o *SqlView) SetCreatedBy(v UserDto) {
	o.CreatedBy = &v
}
...
func (o *SqlView) GetLastUpdatedBy() UserDto {
...
// and a boolean to check if the value has been set.
func (o *SqlView) GetLastUpdatedByOk() (*UserDto, bool) {
	if o == nil || IsNil(o.LastUpdatedBy) {
		return nil, false
	}
...
func (o *SqlView) SetLastUpdatedBy(v UserDto) {
	o.LastUpdatedBy = &v
}
...
func (o *SqlView) GetType() SqlViewType {
	if o == nil {
		var ret SqlViewType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SqlView) GetTypeOk() (*SqlViewType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *SqlView) SetType(v SqlViewType) {
	o.Type = v
}
