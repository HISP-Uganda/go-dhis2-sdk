...
func NewImportConflict(errorCode string) *ImportConflict {
	this := ImportConflict{}
...
func (o *ImportConflict) GetErrorCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ImportConflict) GetErrorCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ImportConflict) SetErrorCode(v string) {
	o.ErrorCode = v
}
