...
type SMSCode struct {
	...
	OptionId               *CategoryOptionCombo    `json:"optionId,omitempty"`
...
func (o *SMSCode) GetDataElement() BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *SMSCode) GetDataElementOk() (*BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.DataElement) {
		return nil, false
	}
...
func (o *SMSCode) SetDataElement(v BaseIdentifiableObject) {
	o.DataElement = &v
}
...
func (o *SMSCode) GetOptionId() CategoryOptionCombo {
...
// and a boolean to check if the value has been set.
func (o *SMSCode) GetOptionIdOk() (*CategoryOptionCombo, bool) {
	if o == nil || IsNil(o.OptionId) {
		return nil, false
	}
...
// SetOptionId gets a reference to the given CategoryOptionCombo and assigns it to the OptionId field.
func (o *SMSCode) SetOptionId(v CategoryOptionCombo) {
	o.OptionId = &v
}

// GetTrackedEntityAttribute returns the TrackedEntityAttribute field value if set, zero value otherwise.
func (o *SMSCode) GetTrackedEntityAttribute() BaseIdentifiableObject {
...
// and a boolean to check if the value has been set.
func (o *SMSCode) GetTrackedEntityAttributeOk() (*BaseIdentifiableObject, bool) {
	if o == nil || IsNil(o.TrackedEntityAttribute) {
		return nil, false
	}
...
func (o *SMSCode) SetTrackedEntityAttribute(v BaseIdentifiableObject) {
