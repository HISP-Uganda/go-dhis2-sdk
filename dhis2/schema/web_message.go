...
type WebMessage struct {
	...
	Response       *WebMessage `json:"response,omitempty"`
...
func NewWebMessage(errorCode string, status string) *WebMessage {
	this := WebMessage{}
...
func (o *WebMessage) GetErrorCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebMessage) GetErrorCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebMessage) SetErrorCode(v string) {
	o.ErrorCode = v
}
...
func (o *WebMessage) HasHttpStatusCode() bool {
	if o != nil && !IsNil(o.HttpStatusCode) {
		return true
	}
...
func (o *WebMessage) GetResponse() WebMessage {
...
// and a boolean to check if the value has been set.
func (o *WebMessage) GetResponseOk() (*WebMessage, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
// SetResponse gets a reference to the given WebMessage and assigns it to the Response field.
func (o *WebMessage) SetResponse(v WebMessage) {
	o.Response = &v
}

// GetStatus returns the Status field value
func (o *WebMessage) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebMessage) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebMessage) SetStatus(v string) {
	o.Status = v
}
